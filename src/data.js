...
export const aboutMe = {
	...
	content: [
		{
			company: "Mivada Technologies Pvt Ltd",
		...
		// {
		// 	company: "SCR, BZA (South Central Railway)",
		// 	role: "Java J2EE Developer Intern",
		// 	duration: "January 2021 - May 2021",
		// 	description:
		// 		"Interned at South Central Railway, Vijayawada, contributing to real-time improvements in internal systems.",
		// 	techStack: ["Java", "J2EE", "Servlets", "JSP"],
		// 	highlights: [
		// 		"Added new features to existing Java-based applications used internally by the railway division.",
		// 		"Contributed to refactoring legacy code for better performance and maintainability.",
		// 		"Collaborated with senior engineers on bug fixes and quality improvements in production systems.",
		// 	],
		// },
	],
};
